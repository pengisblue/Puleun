      ...
      >
        <div className="flex justify-between">
          <div className="flex items-center gap-1">
            <div className="w-8 overflow-hidden rounded-full border border-amber-500 outline outline-1 outline-amber-500">
              <UserProfileImage imgUrl={userImg} />
            </div>
            <img src={wateringCan} alt="wateringCan" className="h-8" />
            <div className="w-8 overflow-hidden rounded-full border border-green-500 outline outline-1 outline-green-500">
              <PotProfileImage imgUrl={potImg} />
            </div>
          </div>
          <p>{createdAt}</p>
        </div>
        <p className="mt-2 text-2xl font-bold">{talkTitle}</p>
      </div>
    </div>
  );
}
